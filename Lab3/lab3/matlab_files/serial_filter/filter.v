...
// Generated on: 2017-01-22 01:51:49
// -------------------------------------------------------------

// -------------------------------------------------------------
// HDL Code Generation Options:
//
// TargetDirectory: C:\Users\erfan\Desktop\lab3\serial1
// SerialPartition: 64
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000011110001; //sfix16_En16
  parameter signed [15:0] coeff2 = 16'b0000000011000000; //sfix16_En16
  parameter signed [15:0] coeff3 = 16'b1111111110010100; //sfix16_En16
  parameter signed [15:0] coeff4 = 16'b1111110110010100; //sfix16_En16
  parameter signed [15:0] coeff5 = 16'b1111110000111011; //sfix16_En16
  parameter signed [15:0] coeff6 = 16'b1111110011101011; //sfix16_En16
  parameter signed [15:0] coeff7 = 16'b1111111101100010; //sfix16_En16
  parameter signed [15:0] coeff8 = 16'b0000000110010011; //sfix16_En16
  parameter signed [15:0] coeff9 = 16'b0000000101111000; //sfix16_En16
  parameter signed [15:0] coeff10 = 16'b1111111100111100; //sfix16_En16
  parameter signed [15:0] coeff11 = 16'b1111110101100000; //sfix16_En16
  parameter signed [15:0] coeff12 = 16'b1111111000111011; //sfix16_En16
  parameter signed [15:0] coeff13 = 16'b0000000101000101; //sfix16_En16
  parameter signed [15:0] coeff14 = 16'b0000001101000100; //sfix16_En16
  parameter signed [15:0] coeff15 = 16'b0000000110101010; //sfix16_En16
  parameter signed [15:0] coeff16 = 16'b1111110110111011; //sfix16_En16
  parameter signed [15:0] coeff17 = 16'b1111101111000110; //sfix16_En16
  parameter signed [15:0] coeff18 = 16'b1111111010001011; //sfix16_En16
  parameter signed [15:0] coeff19 = 16'b0000001110101000; //sfix16_En16
  parameter signed [15:0] coeff20 = 16'b0000010101100110; //sfix16_En16
  parameter signed [15:0] coeff21 = 16'b0000000011101001; //sfix16_En16
  parameter signed [15:0] coeff22 = 16'b1111101000111000; //sfix16_En16
  parameter signed [15:0] coeff23 = 16'b1111100100000011; //sfix16_En16
  parameter signed [15:0] coeff24 = 16'b0000000001000001; //sfix16_En16
  parameter signed [15:0] coeff25 = 16'b0000100101100000; //sfix16_En16
  parameter signed [15:0] coeff26 = 16'b0000100101111110; //sfix16_En16
  parameter signed [15:0] coeff27 = 16'b1111110100011010; //sfix16_En16
  parameter signed [15:0] coeff28 = 16'b1110111011010001; //sfix16_En16
  parameter signed [15:0] coeff29 = 16'b1111000010101011; //sfix16_En16
  parameter signed [15:0] coeff30 = 16'b0000101111110010; //sfix16_En16
  parameter signed [15:0] coeff31 = 16'b0011011000000011; //sfix16_En16
  parameter signed [15:0] coeff32 = 16'b0101010110010000; //sfix16_En16
  parameter signed [15:0] coeff33 = 16'b0101010110010000; //sfix16_En16
  parameter signed [15:0] coeff34 = 16'b0011011000000011; //sfix16_En16
  parameter signed [15:0] coeff35 = 16'b0000101111110010; //sfix16_En16
  parameter signed [15:0] coeff36 = 16'b1111000010101011; //sfix16_En16
  parameter signed [15:0] coeff37 = 16'b1110111011010001; //sfix16_En16
  parameter signed [15:0] coeff38 = 16'b1111110100011010; //sfix16_En16
  parameter signed [15:0] coeff39 = 16'b0000100101111110; //sfix16_En16
  parameter signed [15:0] coeff40 = 16'b0000100101100000; //sfix16_En16
  parameter signed [15:0] coeff41 = 16'b0000000001000001; //sfix16_En16
  parameter signed [15:0] coeff42 = 16'b1111100100000011; //sfix16_En16
  parameter signed [15:0] coeff43 = 16'b1111101000111000; //sfix16_En16
  parameter signed [15:0] coeff44 = 16'b0000000011101001; //sfix16_En16
  parameter signed [15:0] coeff45 = 16'b0000010101100110; //sfix16_En16
  parameter signed [15:0] coeff46 = 16'b0000001110101000; //sfix16_En16
  parameter signed [15:0] coeff47 = 16'b1111111010001011; //sfix16_En16
  parameter signed [15:0] coeff48 = 16'b1111101111000110; //sfix16_En16
  parameter signed [15:0] coeff49 = 16'b1111110110111011; //sfix16_En16
  parameter signed [15:0] coeff50 = 16'b0000000110101010; //sfix16_En16
  parameter signed [15:0] coeff51 = 16'b0000001101000100; //sfix16_En16
  parameter signed [15:0] coeff52 = 16'b0000000101000101; //sfix16_En16
  parameter signed [15:0] coeff53 = 16'b1111111000111011; //sfix16_En16
  parameter signed [15:0] coeff54 = 16'b1111110101100000; //sfix16_En16
  parameter signed [15:0] coeff55 = 16'b1111111100111100; //sfix16_En16
  parameter signed [15:0] coeff56 = 16'b0000000101111000; //sfix16_En16
  parameter signed [15:0] coeff57 = 16'b0000000110010011; //sfix16_En16
  parameter signed [15:0] coeff58 = 16'b1111111101100010; //sfix16_En16
  parameter signed [15:0] coeff59 = 16'b1111110011101011; //sfix16_En16
  parameter signed [15:0] coeff60 = 16'b1111110000111011; //sfix16_En16
  parameter signed [15:0] coeff61 = 16'b1111110110010100; //sfix16_En16
  parameter signed [15:0] coeff62 = 16'b1111111110010100; //sfix16_En16
  parameter signed [15:0] coeff63 = 16'b0000000011000000; //sfix16_En16
  parameter signed [15:0] coeff64 = 16'b0000000011110001; //sfix16_En16
